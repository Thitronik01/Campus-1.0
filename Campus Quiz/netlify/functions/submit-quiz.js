...
const ISLANDS = {
  vejro: require("../../public/data/inseln/vejro.json"),
  poel: require("../../public/data/inseln/poel.json"),
  hiddensee: require("../../public/data/inseln/hiddensee.json"),
  samsoe: require("../../public/data/inseln/samsoe.json"),
  fehmarn: require("../../public/data/inseln/fehmarn.json"),
  usedom: require("../../public/data/inseln/usedom.json"),
  langeland: require("../../public/data/inseln/langeland.json")
};
