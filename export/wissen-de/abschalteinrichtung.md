...
Route: /de/abschalteinrichtung | Stand: 2026-07-14 | Sichtbarkeit: standard
Quelle: Thitronik Online/project-data/runtime/wiki/wiki-articles/de/abschalteinrichtung.json
...
Den Befehl kill an den Pro-Finder senden, vorzugsweise über die THITRONIK® App.

Der Pro-Finder wartet, bis die per GPS ermittelte Geschwindigkeit mindestens 5 Sekunden durchgehend 0 km/h beträgt.

Der Pro-Finder schaltet Ausgang A ein.

Ausgang A steuert die Abschalteinrichtung an. Diese unterbricht den Zündstrom; ein laufender Motor wird abgeschaltet und ein bereits stehendes Fahrzeug bleibt stillgelegt.

Beim Abschalten sendet der Pro-Finder eine Status-SMS. Sie meldet den eingeschalteten Ausgang A und enthält die aktuelle Fahrzeugposition zum Zeitpunkt der Abschaltung.
...
Auf dem Startbildschirm die drei Punkte antippen und „Fahrzeugeinstellungen“ wählen.

Bis zum Bereich „Schaltflächen“ scrollen und „Ausgang A“ auswählen.

Das Stiftsymbol antippen.

„Abschalteinrichtung angeschlossen“ aktivieren. Die erforderlichen Daten werden automatisch eingetragen.

„Bereit“ antippen, um die Einstellung zu übernehmen.

„Fahrzeug speichern“ antippen. Danach erscheint die Kill-Schaltfläche auf dem Startbildschirm.

## Fahrzeug stilllegen und reaktivieren

### Fahrzeug stilllegen

Nach einer SMS- oder Push-Meldung „Diebstahl“ die THITRONIK® App öffnen.

Das STOP-Symbol antippen.

„Fahrzeug stilllegen“ wählen.

Den vorbereiteten Befehl kill senden.

### Fahrzeug reaktivieren

In der App das STOP-Symbol antippen.

„Fahrzeug reaktivieren“ wählen.

Den vorbereiteten Befehl a aus senden. Dadurch wird Ausgang A ausgeschaltet und die Stilllegung aufgehoben.

Das Schalten des Relais kann im Fahrzeug als Klicken hörbar sein.
...
Die Schritte 1 bis 5 insgesamt fünfmal durchführen.
