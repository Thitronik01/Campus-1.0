...
Route: /de/bt-connect | Stand: 2026-07-15 | Sichtbarkeit: standard
Quelle: Thitronik Online/project-data/runtime/wiki/wiki-articles/de/bt-connect.json
...
THITRONIK® App öffnen und das betreffende Fahrzeug auswählen.

Fahrzeugeinstellungen öffnen und BT-connect als vorhandenes Modul auswählen.

Prüfen, dass BT-connect nicht bereits aktiv mit einem anderen Endgerät verbunden ist.

Taster am BT-connect gedrückt halten, bis die LED dauerhaft blau leuchtet.

In der App Koppeln wählen und die angezeigten Schritte bestätigen.

Fahrzeug beziehungsweise Einstellungen speichern.

Verbindung und gewünschte Funktionen im Fahrzeugumfeld kontrolliert testen.
...
Spannungsversorgung des BT-connect trennen.

Taster am Modul gedrückt halten.

Bei weiterhin gedrücktem Taster die Spannungsversorgung wiederherstellen.

Taster gedrückt halten, bis die LED dauerhaft blau leuchtet.

Taster loslassen; alle gespeicherten Geräte sind gelöscht und der Koppelmodus ist aktiv.

Alte BT-connect-Einträge auch aus den Bluetooth-Einstellungen der betroffenen Smartphones und Smartwatches entfernen.

Benötigte Geräte anschließend einzeln über die THITRONIK® App neu koppeln.
