...
Route: /de/co-sensor | Stand: 2026-07-16 | Sichtbarkeit: standard
Quelle: Thitronik Online/project-data/runtime/wiki/wiki-articles/de/co-sensor.json
...
Hauptgerät und betroffene Stromkreise spannungsfrei schalten.

Geeigneten deckennahen Montageort festlegen und Leitungsverlauf prüfen.

Bohrung mit Ø 12 mm herstellen.

Mitgelieferte Hülse entsprechend der Montagezeichnung von außen einsetzen.

Sensor von innen mit den vorgesehenen Schrauben befestigen.

Keine lösungsmittelhaltigen Klebstoffe oder silikonhaltigen Dichtmittel am Sensor verwenden.

Anschlussleitung geschützt und zugentlastet zum Hauptgerät verlegen.

Erst nach vollständiger Verdrahtung und Sichtkontrolle die Versorgung wiederherstellen.
...
Produkt, Hauptgerät, Softwarestand und Ablaufdatum kontrollieren.

Montagehöhe, Befestigung, Leitung und Klemmenbelegung prüfen.

Sicherstellen, dass keine Aderendhülsenregel zwischen den Hauptgeräten verwechselt wurde.

Versorgung des Hauptgeräts wiederherstellen.

Start- beziehungsweise Vorheizphase des Hauptgeräts vollständig abwarten.

Auf Sensorfehler, Dauerton oder abweichende Statusanzeige achten.

Alarmgeber und gegebenenfalls externe Systemanbindungen nach Anleitung des Hauptgeräts prüfen.

Artikelnummer, Sensorseriennummer, „Exp. Date“, Hauptgerät und Einbaudatum dokumentieren.
