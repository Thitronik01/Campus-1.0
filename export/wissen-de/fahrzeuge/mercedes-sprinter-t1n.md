...
Route: /de/fahrzeuge/mercedes-sprinter-t1n | Stand: 2026-07-20 | Sichtbarkeit: standard
Quelle: Thitronik Online/project-data/runtime/wiki/wiki-articles/de/fahrzeuge/mercedes-sprinter-t1n.json
...
Siehe auch Fahrzeugkompatibilität .
...
Entspricht das Fahrzeug dem T1N und dem dokumentierten Zeitraum 2000–2006 ?

Funktionieren Innenbeleuchtung, beide Blinkerzweige und Zündung fehlerfrei?

Welche Fahrerhaus-, Wohnraum- und Klappenkontakte schalten die Innenbeleuchtung tatsächlich?

Bestehen Warnlampen, Beleuchtungsfehler oder andere elektrische Fehler?

Welche zusätzlichen Öffnungen müssen mit Funk-Magnetkontakten abgesichert werden?

## Fahrzeugprofil einstellen

WiPro vollständig von der Versorgung trennen.

Sicherstellen, dass weder der 20-polige Anschlussstecker noch ein Pro-finder verbunden ist.

Gehäusedeckel der Zentrale vorsichtig öffnen.

Für den Universalanschluss SW1 , SW2 , SW3 und SW4 auf OFF stellen.

Weitere DIP-Schalter nur für eine ausdrücklich gewünschte und für Seriennummer sowie Softwarestand freigegebene Sonderfunktion verändern.

Tatsächliche Schalterstellung dokumentieren und Gehäuse wieder schließen.
...
Dauerplus , Masse und Zündung vor dem Anschluss messen.

Sicherungshalter in der Versorgungsleitung zugänglich montieren.

Verbindungen fachgerecht herstellen, mechanisch entlasten und isolieren.

Noch keine Versorgung an die WiPro anlegen, bevor alle weiteren Anschlüsse geprüft sind.
...
Sechspoligen Steckverbinder eindeutig identifizieren.

An rot/gelb Dauerplus der Innenbeleuchtung verifizieren.

An braun/weiß prüfen, dass beim Öffnen einer überwachten Tür Masse geschaltet wird.

Blau, Pin 20, mit rot/gelb verbinden.

Blau/schwarz, Pin 19, mit braun/weiß verbinden.

Jede relevante Tür einzeln öffnen und prüfen, ob sie das Signal auslöst.

Aufbauöffnungen, die nicht auf diese Innenbeleuchtung wirken, benötigen einen eigenen Türkontakt oder einen angelernten Funk-Magnetkontakt . Siehe Funk-Magnetkontakt 868 .
...
Beide Fahrzeugleitungen vor dem Trennen oder Verbinden eindeutig identifizieren.

Mit Warnblinker oder Fahrtrichtungsanzeiger prüfen, welcher Zweig jeweils geschaltet wird.

Grau, Pin 12, mit schwarz/grün verbinden.

Grau, Pin 14, mit schwarz/weiß verbinden.

Verbindungen isolieren und gegen Zug sowie Scheuern sichern.

Nach Inbetriebnahme beide Fahrzeugseiten getrennt und im Alarmfall gemeinsam prüfen.
...
Vor Einbau prüfen, ob die Fahrzeughupe bei ausgeschalteter Zündung tatsächlich verfügbar ist.

Falls nicht, geeignete Sirene oder Back-up Sirene auswählen.

Alarmgeber im Motorraum geschützt vor Hitze, Wasser und beweglichen Teilen montieren.

Verdrahtung nach der jeweiligen Sirenenanleitung ausführen.

Nicht verwendete Leitungen einzeln isolieren.

Akustischen Alarmgeber nach Montage separat prüfen.

Die Back-up Sirene Art. 100089 ist eine mögliche 12-V-Ausführung, jedoch keine in der T1N-PDF festgelegte Pflichtkomponente. Auswahl und Anschluss: Sirenen und Hupen und Artikelnummern-Register .
...
Montageort der Zentrale und Position der Status-LED festlegen.

Vor einer LED-Bohrung den Bereich dahinter kontrollieren und den Bohrdurchmesser an der tatsächlich mitgelieferten Status-LED beziehungsweise ihrer Montagevorgabe prüfen.

Funk-Zubehör mit Kennzeichnung 868 vor der endgültigen Montage anlernen.

Jeden Sender am geplanten Montageort auf zuverlässigen Empfang prüfen.

Zentrale und Leitungen so befestigen, dass nichts in den Pedalbereich oder an bewegliche Fahrzeugteile gelangen kann.

Funk-Magnetkontakte erst nach erfolgreichem Reichweiten- und Funktionstest endgültig befestigen.

Einzelheiten zum Anlernen: Anlernvorgang .

## Inbetriebnahme und Funktionstest

Alle Anschlüsse, Isolierungen und die 10-A -Sicherung nochmals prüfen.

Bestätigen, dass SW1–SW4 auf OFF stehen.

WiPro an die Versorgung anschließen und auf die Einschaltreaktion achten.

System schärfen und Aktivierungsquittung über Status-LED und Blinker prüfen.

Jede Fahrerhaustür einzeln öffnen und kontrollieren, ob das Innenbeleuchtungssignal einen Alarm auslöst.

Jede Aufbau- und Stauraumöffnung mit eigenem Kontakt einzeln testen.

Beide Blinkerzweige bei Schärfung und Alarm prüfen.

Sirene oder Back-up Sirene mit einem realen Testalarm prüfen.

System entschärfen und prüfen, ob der Alarm zuverlässig beendet wird.

Zündung einschalten und sicherstellen, dass die Anlage während der Fahrt keinen Alarm auslöst.

Abschließend kontrollieren, dass Innenbeleuchtung, Blinker und übrige Fahrzeugelektrik weiterhin fehlerfrei arbeiten.

DIP-Stellung, Anschlusspunkte, Sicherung und verbautes Zubehör in den Kundenunterlagen dokumentieren.
