...
Route: /de/fahrzeuge/vw-t6-1 | Stand: 2026-07-22 | Sichtbarkeit: standard
Quelle: Thitronik Online/project-data/runtime/wiki/wiki-articles/de/fahrzeuge/vw-t6-1.json

---
VW T6.1 (ab 2019)

Diese Seite beschreibt den Einbau einer WiPro III in den VW T6.1 ab Modelljahr 2019. Maßgeblich ist das zehnseitige gemeinsame Einbauhandbuch für T6 und T6.1, Stand 12/20 ; das allgemeine WiPro-III-Installationshandbuch Revision 1.8 ergänzt Sicherheit und die Pinbelegung des 20-poligen Kabelsatzes.

Abgrenzung: Für den Vorgänger der Modelljahre 2015–2019 gilt VW T6 (2015–2019) . Das gemeinsame Fahrzeughandbuch zeigt für T6 und T6.1 unterschiedliche DIP-Profile, Mindestseriennummern und CAN-High-Leitungen. Diese Seite darf ausschließlich für den T6.1 ab Modelljahr 2019 verwendet werden.
...
Thema | Freigegebene Aussage | 
 Fahrzeugprofil | ausschließlich T6.1 ab Modelljahr 2019 mit SW2 + SW3 + SW4 + SW6 | 
 Gerätebasis | Universal-Set 100754 , WiPro ab Seriennummer 0823-019 | 
 CAN-Leitungen | T6.1 orange/braun und grün; die T6-Belegung orange/grün wird nicht übertragen | 
...
T6.1 eindeutig vom T6 der Modelljahre 2015–2019 abgrenzen.

Universal-Set 100754 und Seriennummer ab 0823-019 bestätigen.
...
Beim T6.1 ausschließlich SW2 , SW3 , SW4 und SW6 auf ON stellen.

Alle anderen Schalter in der im Fahrzeughandbuch dargestellten Grundstellung belassen.

Nicht das darüber abgebildete T6-Profil SW3 + SW4 + SW6 übernehmen.
...
Fahrzeugleitung / Ort | WiPro-Leitung / Pin | Funktion | 
 ...
 grün am Sicherungskasten/Kabeltunnel | weiß/orange, Pin 17 | CAN-High | 
...
Grüne Leitung messen und mit weiß/orange Pin 17 über einen gelgefüllten Verbinder verbinden.
...
DIP-Stellung SW2 + SW3 + SW4 + SW6 und Seriennummer ab 0823-019 nochmals prüfen.
...
Fehlerbild | Prüfung / Maßnahme | 
 ...
 WiPro reagiert nicht auf Fahrzeugfernbedienung | CAN-Leitungen und DIP-Profil prüfen; T6.1-Farben nicht mit T6 verwechseln | 
 keine CAN-Aktivität im Diagnosemodus | Buszustand, gelgefüllte Verbinder, orange/braun Pin 18 und grün Pin 17 prüfen | 
...
DIP-Stellung SW2 + SW3 + SW4 + SW6 dokumentieren.
...
Die Matrixangabe Software 6.8 wird nicht als fahrzeugspezifischer Mindeststand fortgeführt, weil die Primärquelle für den T6.1 ausschließlich die Mindestseriennummer 0823-019 nennt.
