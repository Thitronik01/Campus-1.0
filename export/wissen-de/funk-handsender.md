...
Route: /de/funk-handsender | Stand: 2026-07-18 | Sichtbarkeit: standard
Quelle: Thitronik Online/project-data/runtime/wiki/wiki-articles/de/funk-handsender.json
...
Eine Taste am Funk-Handsender drücken.
...
Die Schrauben am Gehäuse entfernen und den Handsender öffnen.

Die verbrauchte Knopfzelle entnehmen.

Eine neue CR2032, 3 V mit korrekter Polung einsetzen.

Die Knopfzelle möglichst nicht an den Kontaktflächen mit bloßen Fingern berühren.

Das Gehäuse schließen und wieder verschrauben.

Die Funktion am Fahrzeug prüfen.
