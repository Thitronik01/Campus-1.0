...
Route: /de/gas | Stand: 2026-07-16 | Sichtbarkeit: standard
Quelle: Thitronik Online/project-data/runtime/wiki/wiki-articles/de/gas.json
...
Spannungsfreien Montageort anhand der Abstandsvorgaben festlegen und verdeckte Leitungen oder Bauteile vor dem Bohren ausschließen.
...
Anschlussleitung spannungsfrei zum Montageort führen.

Die rückseitigen Gehäuseaussparungen über die Schraubenköpfe setzen und das Gerät nach unten schieben.

Sitz und Luftzugang prüfen; das Gehäuse darf nicht verspannt sein.
...
Den Taster an der Geräteunterseite mindestens 2 Sekunden drücken.

Drei kurze Signaltöne bestätigen das Einschalten.

Während der Aufwärmphase leuchtet die Anzeige gelb.

Die Aufwärmphase dauert normalerweise etwa 3 Minuten; bei der ersten Inbetriebnahme kann sie bis zu 20 Minuten dauern.

Grün blinkende Anzeige bedeutet Betriebsbereitschaft.
...
Die interne Sirene alarmiert 30 Sekunden lang mit voller Lautstärke.

Ein kurzer Druck auf den Taster schaltet die interne Sirene stumm; die rote Anzeige blinkt weiter.

Nach weiteren 30 Sekunden kehrt das Gerät in den Normalbetrieb zurück.

Wird die Schwelle erneut länger als 30 Sekunden überschritten, startet der Alarmablauf erneut.
...
Versorgung, sichtbare Kabelschäden und Steck-/Klemmverbindungen nur spannungsfrei prüfen.

Gerät erneut einschalten und die vollständige Aufwärmphase abwarten.

Bleibt der Fehler bestehen, Gerät nicht als Schutzsystem verwenden und den THITRONIK-Support beziehungsweise einen Fachbetrieb kontaktieren.
...
Bei Beschwerden, starker Gaskonzentration oder unklarer Lage den Notruf beziehungsweise die zuständigen Einsatzkräfte verständigen.

Fahrzeug erst wieder betreten und Gasgeräte erst wieder benutzen, wenn die Ursache fachgerecht geklärt und die Atmosphäre sicher ist.
