...
Route: /de/mobilfunk-sim | Stand: 2026-07-15 | Sichtbarkeit: standard
Quelle: Thitronik Online/project-data/runtime/wiki/wiki-articles/de/mobilfunk-sim.json
...
Welche Mobilfunktechnik unterstützt der konkrete Pro-Finder anhand seiner Seriennummer?

In welchem Netz arbeitet der Tarif tatsächlich? Bei einem virtuellen Anbieter zählt auch das Hostnetz.

Sind SMS und Telefonie in diesem Tarif und am Einsatzort verfügbar?

Wird bei Auslandsnutzung in ein kompatibles Partnernetz eingebucht?

Sind Roaming, SMS und Telefonie freigeschaltet und entstehen zusätzliche Kosten?

Bleibt die SIM dauerhaft aktiv, oder gelten Auflade- und Nutzungsfristen?
...
SIM aktivieren und eventuelle Identitätsprüfung abschließen.

PIN entsprechend der Seriennummerntabelle einstellen.

Mailbox, Rufumleitungen und Komfortdienste deaktivieren. Die nötigen Codes sind anbieter- und geräteabhängig; deshalb nur bestätigte Angaben des Providers verwenden.

Rufnummer, Tarifstatus und bei Prepaid das Guthaben prüfen.

Einen ausgehenden und einen eingehenden Anruf testen.

Eine klassische SMS senden und empfangen.

Für Reisen Roaming erst nach Prüfung von Tarif, Partnernetz und Kosten aktivieren.

Smartphone ausschalten, SIM entnehmen und nur bei spannungsfreiem Pro-Finder einsetzen.
...
Pro-Finder spannungsfrei schalten.

SIM in der richtigen Lage und ohne Gewalt einsetzen.

Spannung wieder einschalten und das Einbuchen abwarten.

Programmier-SMS exakt und ohne zusätzliche Leerzeichen senden.

Antwort-SMS prüfen.

Pro-Finder anrufen und einen kontrollierten Alarmtest durchführen.

Bei Prepaid nach dem Test das verbleibende Guthaben prüfen.
