...
Route: /de/stoerungsbeseitigung | Stand: 2026-07-15 | Sichtbarkeit: standard
Quelle: Thitronik Online/project-data/runtime/wiki/wiki-articles/de/stoerungsbeseitigung.json
...
Erwartetes und tatsächliches Verhalten sowie die genaue Bedienreihenfolge dokumentieren.

Seriennummern, Softwarestände , Fahrzeug und Modelljahr erfassen.

Status-LED, Blinkcode, Signalton, App-Meldung oder SMS möglichst wörtlich festhalten.

Versorgungsspannung und sichtbare Steckverbindungen prüfen, ohne sicherheitsrelevante Verdrahtung zu verändern.

Immer nur eine Maßnahme durchführen und ihr Ergebnis dokumentieren.
