...
Route: /de/vernetzungsmodul | Stand: 2026-07-16 | Sichtbarkeit: standard
Quelle: Thitronik Online/project-data/runtime/wiki/wiki-articles/de/vernetzungsmodul.json
...
Bestandsprodukt: Die Projektunterlagen führen das Bluetooth-Vernetzungsmodul seit September 2025 als eingestellt und BT-connect als Nachfolger. Vor Bestellung oder Ersatzteilzusage die tatsächliche Verfügbarkeit prüfen.
...
Geeigneten Montageort in der Nähe der WiPro III wählen.

Sicherstellen, dass Taster, blaue LED und Steckverbindungen nach der Montage erreichbar bleiben.

WiPro III beziehungsweise WiPro III safe.lock mit dem mitgelieferten RJ10-Kabel an eine der beiden Buchsen anschließen.

Einen vorhandenen Pro-Finder bei Bedarf an die zweite RJ10-Buchse anschließen.

GND und 12/24-V-Dauerversorgung entsprechend dem dokumentierten Kabelbaum anschließen.

Spannungsversorgung parallel zu WiPro III und/oder Pro-Finder herstellen.

Vor der endgültigen Befestigung Kopplung, Alarmbedienung und gegebenenfalls Zentralverriegelung testen.

Leitungen zugentlastet verlegen und vor Scheuern, Quetschen und Feuchtigkeit schützen.
...
THITRONIK® App öffnen.

Fahrzeugeinstellungen aufrufen.

Vernetzungsmodul auswählen beziehungsweise das Häkchen setzen.

Den Bildschirmanweisungen folgen und das Modul auf Aufforderung in den Koppelmodus versetzen.

Angezeigte Bluetooth-Kopplung am Smartphone oder an der Smartwatch bestätigen.

Den Vorgang in der App abschließen.

Am Ende die Einstellungen speichern .

Scharf-/Unscharfschalten und gegebenenfalls Ver-/Entriegeln getrennt testen.
...
Spannungsversorgung des Vernetzungsmoduls trennen.

Taster am Modul gedrückt halten.

Bei weiterhin gedrücktem Taster die Spannungsversorgung wiederherstellen.

Taster weiter gedrückt halten, bis die blaue LED dauerhaft leuchtet .

Taster loslassen; alle angelernten Geräte sind gelöscht und der Anlernmodus ist gleichzeitig aktiv.

Das Vernetzungsmodul zusätzlich in den Bluetooth-Einstellungen der betroffenen Endgeräte löschen.

Benötigte Smartphones und Smartwatches anschließend einzeln über die THITRONIK® App neu koppeln.

Alle Bedienfunktionen kontrolliert testen.
